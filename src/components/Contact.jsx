...
export default function Contact() {
  ...
  return (
    <SectionReveal className="space-y-12" id="contact">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <motion.div variants={fadeInUp} className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <div className="flex-1">
                  <p className="text-label-md font-label-md text-primary uppercase tracking-widest">Email</p>
            ...
            <motion.a
              ...
              href="tel:+918438849180"
            >
              <div className="w-12 h-12 rounded-full border border-outline-variant/30 flex items-center justify-center group-hover:border-primary transition-colors">
                <span className="material-symbols-outlined text-primary">call</span>
              </div>
              <div>
                <p className="text-label-md font-label-md text-primary uppercase tracking-widest">Phone</p>
        ...
        <motion.div variants={fadeInUp} className="glass-panel p-8 rounded-2xl crimson-glow border border-outline-variant/10">
          <motion.form className="space-y-4" onSubmit={handleSubmit} whileTap={{ scale: 0.999 }}>
            ...
            <motion.button
              ...
              whileTap="tap"
              variants={buttonTap}
              className="w-full py-4 bg-primary-container text-on-primary-container font-display font-bold uppercase tracking-widest rounded-lg hover:brightness-110 transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary-container/20"
              type="submit"
            >
